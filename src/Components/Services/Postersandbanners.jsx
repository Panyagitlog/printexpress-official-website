import PosterBanner from "../Images/PosterBanner.png"
const Postersandbanners = () => {
  return (
    <div>
      <section>
  {/* <!-- Container --> */}
  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
    ...
    <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
      {/* <!-- Image --> */}
      <div className="min-h-[530px] overflow-hidden rounded-md bg-white-100 mt-4">
        <img
          src={PosterBanner}
          alt=""
      ...
      <div className="flex flex-col items-start gap-2">
        ...
        {/* <!-- Title --> */}
        <h1 className="text-red-500 mb-6 text-4xl font-bold md:text-6xl lg:mb-8">
          Posters & Banners
        </h1>
        <p className="text-sm text-gray-500 sm:text-xl">
          Large Format Printing for Impactful Posters Durable Banners for Events and Promotions Custom Sizes and Designs to Capture Attention
        </p>
        {/* <!-- Divider --> */}
...
export default Postersandbanners