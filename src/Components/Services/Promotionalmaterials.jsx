import PromotionalMaterial from "../Images/PromotionalMaterials.png"
  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
    ...
    <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
      ...
      <div className="flex flex-col items-start gap-2">
        ...
        <p className="text-sm text-gray-500 sm:text-xl">
          Unique Promotional Items and Giveaways Branded Merchandise for Marketing Campaigns Creative Solutions to Boost Brand Visibility
        </p>
        {/* <!-- Divider --> */}
      ...
      {/* <!-- Image --> */}
      <div className="min-h-[530px] overflow-hidden rounded-md bg-white-100 mt-8">
        <img
          href="https://wa.me/+918766912880"
          src={PromotionalMaterial}
          alt=""
