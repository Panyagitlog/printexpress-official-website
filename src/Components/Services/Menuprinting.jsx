import MenuPrinting from "../Images/MenuPrinting.png"
  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
    ...
    <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
      ...
      <div className="flex flex-col items-start gap-2">
        ...
        <p className="text-sm text-gray-500 sm:text-xl">
          High-Quality Menu Printing for Restaurants and Cafes Customizable Designs to Match Your Branding Laminated Options for Durability
        </p>
        {/* <!-- Divider --> */}
