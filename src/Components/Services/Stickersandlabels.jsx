import StickerLable from "../Images/StickersLabels.png"
  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
    ...
    <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
      ...
      <div className="flex flex-col items-start gap-2">
        ...
        {/* <!-- Title --> */}
        <h1 className="bg-gradient-to-r from-red-500 to-red-500 bg-clip-text text-transparent mb-6 text-4xl font-bold md:text-6xl lg:mb-8">
          Stickers and Labels
        </h1>
        <p className="text-sm text-gray-500 sm:text-xl">
          Custom Sticker and Label Printing
          Options for Various Shapes and Sizes
          Ideal for Branding and Product Packaging
        </p>
        {/* <!-- Divider --> */}
