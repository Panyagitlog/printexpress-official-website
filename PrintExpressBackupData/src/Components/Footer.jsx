    ...
    <div className="bg-gradient-to-r from-blue-900 via-gray-900 to-gray-800 text-white">
      <footer>
        <div className=" flex-col lg:flex px-5 py-16 md:px-10 md:py-20 ">
          ...
          <div className="lg:flex lg:flex-row lg:justify-between">
            ...
            <div className="flex grow flex-row flex-wrap lg:mx-10 lg:flex-nowrap lg:justify-center">
              ...
              <div className="my-5 mr-8 flex max-w-52 grow basis-24 flex-col space-y-5 lg:mx-10 lg:mt-0">
                <h2 className="font-inter font-medium text-white">SERVICES</h2>
              ...
              {/* LINK BLOCK */}
              <div className="my-5 mr-8 flex max-w-52 grow basis-24 flex-col space-y-5 lg:mx-10 lg:mt-0">
                <h2 className="font-inter font-medium text-white">PROJECT</h2>
                <a href="" className="font-inter font-light text-white">
                  Pricing
                </a>
                <a href="" className="font-inter font-light text-white">
              ...
              {/* LINK BLOCK */}
              <div className="my-5 mr-8 flex max-w-52 grow basis-24 flex-col space-y-5 lg:mx-10 lg:mt-0">
                <h2 className="font-inter font-medium text-white">INFRA</h2>
                <a href="" className="font-inter font-light text-white">
                  About
                </a>
                <a href="" className="font-inter font-light text-white">
            ...
            <div className="mt-10 flex flex-col lg:mt-0">
              ...
              <div className="mb-4 flex flex-row items-center max-w-72">
                ...
                <p className="font-inter ml-4 text-white">
                  Shree Sankalp, Ingale wasti, Nahre Gaon, Pune, India
                </p>
              </div>
              {/* ITEM */}
              <div className="mb-4 flex flex-row items-center max-w-72">
          ...
          {/* DIVIDER */}
          <div className="mx-auto my-12 w-full border border-gray-300 lg:my-20 bg-white"></div>
          {/* COPYRIGHT TEXT */}
          <div>
