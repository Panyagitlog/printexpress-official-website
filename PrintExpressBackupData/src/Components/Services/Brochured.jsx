      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
        ...
        <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            {/* <!-- Title --> */}
            <h1 className="mb-6 text-4xl font-bold md:text-6xl lg:mb-8 bg-gradient-to-r from-red-500 to-red-500 bg-clip-text text-transparent">
              Brochures
            </h1>
            <p className="text-sm text-gray-500 sm:text-xl">
              Customized Brochure Design and Printing Multiple Folding Options
              for Varied Content Glossy or Matte Finishes for a Professional
              Look
            </p>
            {/* <!-- Divider --> */}
          ...
          {/* <!-- Image --> */}
          <div className="min-h-[530px] overflow-hidden rounded-md bg-white">
            <img
              src="https://i.ibb.co/PwTPxW0/Prompt-for-Leonardo-ai-Style-Minimalist-futuristic-or-sleek-Colors-Choose-a-color-palette-that-compl.png"
              alt=""
