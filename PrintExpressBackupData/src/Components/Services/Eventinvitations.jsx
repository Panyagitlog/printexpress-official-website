  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
    ...
    <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
      ...
      <div className="min-h-[530px] overflow-hidden rounded-md bg-white-100 mt-4">
        <img
          src="https://i.ibb.co/0CgHh2L/Leonardo-Phoenix-Create-a-3-D-image-of-a-collection-of-elegant-2.jpg"
          alt=""
      ...
      <div className="flex flex-col items-start gap-2">
        ...
        <p className="text-sm text-gray-500 sm:text-xl">
          Elegant and Custom Event Invitation Printing
          Range of Paper Choices and Finishes
          Design Consultation for Special Occasions
        </p>
        {/* <!-- Divider --> */}
