  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
    ...
    <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
      ...
      <div className="min-h-[530px] overflow-hidden rounded-md bg-white-100 mt-4">
        <img
          src="https://i.ibb.co/WtPqChh/Untitled-design-10.png"
          alt=""
      ...
      <div className="flex flex-col items-start gap-2">
        ...
        <p className="text-sm text-gray-500 sm:text-xl">
          Eco-Friendly Paper Bags with Custom Designs
          Various Sizes and Handles to Suit Your Needs
          Sustainable Printing Practices for Green Solutions
        </p>
        {/* <!-- Divider --> */}
