  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
    ...
    <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
      ...
      <div className="flex flex-col items-start gap-2">
        ...
        <p className="text-sm text-gray-500 sm:text-xl">
          Premium Business Card Printing with Custom Designs
          Variety of Paper Options and Finishes
          Compact and Impactful Representation of Your Brand
        </p>
        {/* <!-- Divider --> */}
      ...
      <div className="min-h-[530px] overflow-hidden rounded-md bg-white-100 mt-8">
        <img
          src="https://i.ibb.co/qmCnP32/Untitled-design-13.png"
          alt=""
