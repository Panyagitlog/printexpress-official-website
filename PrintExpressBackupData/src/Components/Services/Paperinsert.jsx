...
const Paperinsert = () => {
  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
    {/* <!-- Component --> */}
    <div className="grid gap-12 sm:gap-10 lg:grid-cols-2">
      {/* <!-- Image --> */}
      <div className=" min-h-[530px] overflow-hidden rounded-md bg-white-100">
        <img
          src="https://i.ibb.co/hcpsTJ2/Newspaper-Insert-Advertising-Unveil-the-unique-power-of-newspaper-inserts-advertising-with-us-Your-b.png"
          alt=""
          className=" mb-0 inline-block transition-all duration-300 hover:scale-110"
        />
      </div>
      {/* <!-- Content --> */}
      <div className="flex flex-col items-start gap-2">
        ...
        {/* <!-- Title --> */}
        <h1 className="text-red-500 mb-2 text-4xl font-bold md:text-6xl lg:mb-8">
          Paper Inserts
        </h1>
        <p className="text-sm text-gray-500 sm:text-xl">
          Vibrant and Customized Paper Inserts High-Quality Printing with Sharp Graphics Options for Different Paper Types and Finishes
        </p>
        {/* <!-- Divider --> */}
